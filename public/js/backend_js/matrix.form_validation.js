...
// //sweet Alert for delete Selected data
// $(document).on('click', '.deleteSelectedRecord', function (e) {
//     var id = $(this).attr('rel');
//     var deleteFunction = $(this).attr('rel1');
//     swal({
//             title: "Are you sure?",
...
//Add remove multiple fields jquery of product Attribute
$(document).ready(function(){
...
//Add remove multiple fields jquery of product color
$(document).ready(function () {
    var maxField = 10; //Input fields increment limitation
    var addButton = $('.add_field'); //Add button selector
    var wrapper = $('.field_wrapper'); //Input field wrapper
    var fieldHTML = '<div class="field_wrapper" style="margin-left:170px;"><div style="margin-left:10px;"><input type="text" name="product_color[]" id="product_color" placeholder="Color" style="width:120px;margin-right:3px; margin-top:5px;"/><a href="javascript:void(0);" class="remove_button" title="Remove field">Remove</a></div>'; //New input field html 
    var x = 1; //Initial field counter is 1
