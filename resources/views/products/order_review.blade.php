            ...
            <tr>
                ...
                <td colspan="2">
                    <table class="table table-condensed total-result">
                        ...
                        <td><span class="btn btn-secondary" data-toggle="tooltip" data-html="true" title=" USD {{ $getCurrencyRates['USD_Rate'] }} <br>
                        GBP {{ $getCurrencyRates['GBP_Rate'] }} <br>
                        EURO {{ $getCurrencyRates['EURO_Rate'] }} ">Rs. {{$grand_total}}</span></td>
                        </tr>
                    </table>
                </td>
            </tr>
