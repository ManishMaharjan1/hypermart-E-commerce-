...
<div class="contactinfo">
    <ul class="nav nav-pills">
        <li><a href="http://www.3hammers.com/contact"><i class="fa fa-phone"></i> +977 1 4433 860</a></li>
        <li><a href="http://www.3hammers.com"><i class="fa fa-envelope"></i> info@3hammers.com</a></li>
    </ul>
</div>
</div>
<div class="col-sm-6">
<div class="social-icons pull-right">
    <ul class="nav navbar-nav">
        <li><a href="https://www.facebook.com/3hammers"><i class="fa fa-facebook"></i></a></li>
        <li><a href="#"><i class="fa fa-twitter"></i></a></li>
        <li><a href="https://www.linkedin.com/company/3hammers/about/"><i class="fa fa-linkedin"></i></a></li>
